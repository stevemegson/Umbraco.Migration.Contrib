...
{
    public class LegacyPickersPropertyEditors : PropertyEditorsMigrationBase
    {
        private Lazy<Dictionary<int, NodeDto>> _nodeIdToKey;

        public LegacyPickersPropertyEditors(IMigrationContext context)
            : base(context)
        { }
        ...
        public override void Migrate()
        {
            ...
            var refreshCache = Migrate("Umbraco.ContentPickerAlias", ValueStorageType.Nvarchar);
        ...
        private bool Migrate(string alias, ValueStorageType valueType)
        {
            ...
            {
                Context.Logger.Info<LegacyPickersPropertyEditors>("Migrating " + dataType.EditorAlias + ", " + dataType.NodeId);
